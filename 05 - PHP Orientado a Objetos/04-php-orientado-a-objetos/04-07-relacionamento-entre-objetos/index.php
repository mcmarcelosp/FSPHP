...
$address = new \Source\Related\Address("Manoel Bacelar", 481, "Bloco A, Sala 2010");
$company->boot(
    "UpInside",
    $address
    );
...
echo "<p>A {$company->getCompany()} tem sede na rua {$company->getAddress()->getStreet()}</p><br>";
...
$fsphp = new \Source\Related\Product("Full", 2563);
...
$company->addProduct(
    new \Source\Related\Product("Work Control", 2997)
);
